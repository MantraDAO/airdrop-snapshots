...
const get_transfers = async() => {
    let response = await axios.post(
        'https://api.thegraph.com/subgraphs/name/tomtsaomantra/bsc-om-token-subgraph',
        {
...
(async () => {
    ...
    await csv.toDisk('./output/legacy-snapshot-data/bsc-polygon-snapshots/bsc_om.csv');
})()
